...
def entity_signup():    
      ...
      driver.find_element(By.XPATH,'//*[@id="root"]/div/section/div/div/div/div/div/form/div[1]/fieldset/div/label[4]/span[1]/span[1]/input').click()
      ...
      select.select_by_visible_text('LLC')

      select=Select(driver.find_element(By.NAME,'classification'))
      select.select_by_visible_text('C Corporation')
